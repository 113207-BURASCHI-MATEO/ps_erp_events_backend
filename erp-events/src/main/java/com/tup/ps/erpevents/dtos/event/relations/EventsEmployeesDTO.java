...
@AllArgsConstructor
@NoArgsConstructor
public class EventsEmployeesDTO {
    ...
    @Schema(description = "ID del empleado", example = "12")
    private Long idEmployee;

    @Schema(description = "Estado del pago", example = "PENDING")
    private AmountStatus status;

    @Schema(description = "Monto asignado", example = "1500.00")
    private Double amount;

    @Schema(description = "Saldo restante", example = "500.00")
